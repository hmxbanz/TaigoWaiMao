...
public class UnityPlayerActivity extends BaseActivity
{
    ...
    @Override protected void onCreate (Bundle savedInstanceState)
    {
        ...
        //权限申请
        PermissionsManager.getInstance().requestPermissionsIfNecessaryForResult(this,new String[]{Manifest.permission.CAMERA,Manifest.permission.READ_PHONE_STATE}, new PermissionsResultAction() {
            @Override
            ...
            case QRSCANNING:
                ...
                if (null != data) {
                    ...
                    if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                        ...
                        Toast.makeText(this, "扫描成功:" + qrCode, Toast.LENGTH_LONG).show();
    ...
    private void isActivitied()
    {
        ...
        else
        {
            ...
            IMEI= CommonTools.getIMEI(this);
            presenter.editor.putString("CellPhoneID",IMEI).commit();
